...
Scanned images of the original printing of this book (our authoritative source) are available \href{https://archive.org}{here}.
...
\tightlist
\item
  \textbf{Current Status}\emph{Unstarted} -- Empty project files created, but that's it.
\item
  \emph{Rough} -- Metadata entered, computer-generated text from scans entered. Unstructured, and likely to include many errors.
\item
